package com.helloworldapi.helloworld_api.Interceptors;
...
@Component
public class ConsentInterceptor implements IConsentService {
	...
	public ConsentOutcome startOperation(RequestDetails theRequestDetails, IConsentContextServices theContextServices) {
		System.out.println("LOG MESSAGE: YOU MADE INTO THE INTERCEPTOR");
	...
	public ConsentOutcome canSeeResource(RequestDetails theRequestDetails, IBaseResource theResource, IConsentContextServices theContextServices) {
		...
		if (theResource instanceof Patient) {
			...
			//TODO 	call fhir api to collect consent resources that relate to patinets 
