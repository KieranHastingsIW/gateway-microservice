...
* Run the `SELECT * FROM users_table;` query, the output should be a 5 column by 100 row table with all attributes of the user model as the headers for the columns.
